...
public enum ApiErrorCode {
    ...
    NOT_RELATED_USER, ORK_ALREADY_DUE,UNIT_NOT_FOUND,NULL,Booking_time_must_be_between_8AM_and_5_PM,NO_BOOKING_ALLOWED_AT_THIS_TIME,
    BOOKING_NOT_FOUND, PASSWORD_EXISTED, USERNAME_OR_PASSWORD_ERROR,START_DATE_BEFORE_TODAY,USER_IS_NOT_AUTHENTICATED;
